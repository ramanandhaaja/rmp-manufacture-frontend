...
export const HEADER_HEIGHT_CLASS = "h-[3.3125rem]"
export const PAGE_CONTAINER_GUTTER_X = "px-5 sm:px-5 md:px-5"
export const PAGE_CONTAINER_GUTTER_Y = "py-3 sm:py-3 md:px-5"
